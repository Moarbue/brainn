...
LIB_OBJ  = $(LIB_PATH)/activation.o $(LIB_PATH)/loss.o $(LIB_PATH)/mat.o $(LIB_PATH)/nn_io.o $(LIB_PATH)/nn_parallel.o $(LIB_PATH)/nn.o $(LIB_PATH)/vec_mat.o $(LIB_PATH)/vec.o $(LIB_PATH)/buffer.o $(LIB_PATH)/serialization.o 
